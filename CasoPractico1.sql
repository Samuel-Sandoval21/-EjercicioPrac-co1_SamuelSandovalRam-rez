...
-- 4) Tabla quejas (sugerencias/consultas)
...
('Tecnología', 'Libros sobre programación, IA y tecnología.'),
...
('Clean Code', 'Robert C. Martin', '978-0132350884', 'Manual de buenas prácticas de programación.', 3, '2008-08-01', 29.99),
('Sapiens: De animales a dioses', 'Yuval Noah Harari', '978-8499926223', 'Breve historia de la humanidad.', 4, '2014-09-04', 22.50);
...
('Carlos Rodríguez', 'carlos.rodriguez@email.com', '506-7777-5555', 'CONSULTA', 'Préstamos digitales', '¿Ofrecen servicio de préstamo de libros digitales?');

-- 8) Comprobaciones opcionales
